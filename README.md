...
The implementation mitigates this by masking the property before page scripts execute
...
|**schenkers_api.py**||
|-|-|
|**SchenkerClient**| The object containing the playwright chromium browser used to fetch the data from schenkers webbsite. It starts a chromium browser when first created.
